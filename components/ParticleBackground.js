...
const ParticlesBack = () => {
    ...
    return (
        ...
        options={particlesConfig}/> <Center mt={ isSmallerThan721? "7" :"10vh"}> <Box width={"80%"}>
            ...
            <Center> <Box borderRadius={"5"}  mt={"10vh"} borderColor={"#F3BA2F"} maxW={isSmallerThan721 ? "100%" : "50%"}>
            ...
            <Center mt={"10vh"}> { isSmallerThan721 ?
                ...
                <VStack gap={"10vh"}>
                    ...
                    <Flex direction={"column"} width={"50vh"} ml={"20vh"}>
                        ...
                        <Text alignSelf={"flex-end"} color={"white"}> Address that may have special privileges </Text> </Flex>
            ...
            <RadioGroup onChange={setSupply} value={supply}>
                <Center> <Flex mt={"10vh"} direction={isSmallerThan721 ? "column" : "row"} rowGap={"5vh"}>
                    ...
                    <Box maxW={isSmallerThan721 ? "100%" :"31%"}> <ScaleFade whileHover={{ scale: 1.2 }}
                               initialScale={1}
            ...
            {isSmallerThan721 ? <Center> <VStack> <Heading size={"xl"} mt={"20vh"} color={"#F3BA2F"}> PICK AVAILABLE </Heading> <Heading size={"xl"} mt={"20vh"} color={"#F3BA2F"}> ACTIONS </Heading> </VStack> </Center>
                :
            <Center> <Heading size={"xl"} mt={"20vh"} color={"#F3BA2F"}> PICK AVAILABLE ACTIONS </Heading> </Center>}


            <Center> <Flex direction={isSmallerThan721 ? "column" : "row"} mt={"20vh"} columnGap={"10vh"} rowGap={"10vh"}>
            ...
            <Center> <VStack mt={isSmallerThan721 ? "5vh" : 0}> {isSmallerThan721 ? <Text align={"center"} color={"white"}> Within a few minutes you will get a notification about the success of your token deployment </Text> : <Heading size={"md"} mt={"10vh"} color={"white"}> Within a few minutes you will get a notification about the success of your token deployment</Heading>}<Heading size={"md"} mt={"10vh"} color={"white"}> After that  </Heading>  </VStack> </Center>

            <Center> <Heading size={"md"} mt={"10vh"} color={"white"}> Or! </Heading> </Center>
            <Center> { isSmallerThan721 ? <Text fontSize={"xl"} align={"center"} mt={"3vh"} color={"#F3BA2F"}> If you ever miss/forget/lose your token address </Text> : <Heading size={"md"} mt={"3vh"} color={"#F3BA2F"}> If you ever miss/forget/lose your token address </Heading> }</Center>
